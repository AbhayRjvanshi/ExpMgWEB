...
.agents/orchestration/design_evaluation_report.json` (syntax-only check — upgrade to schema validation once `
.agents/core/contracts/design_evaluation_report.schema.json` is created).
